use crate::capabilities::Map as Capabilities;
...
impl Base {
    ...
    fn from_capabilities(map: &Capabilities) -> Self {
        Self {
...
pub(crate) trait CapabilitiesExt {
...
static LOCAL_CAPABILITIES: OnceCell<Capabilities> = OnceCell::new();

pub(super) fn local() -> &'static Capabilities {
