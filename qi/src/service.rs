...
mod tests {
    use super::*;
    use crate::{messaging, value::BinaryFormattedValue};
    ...
    fn service_info_from_binary_value() {
        ...
        let service_info: Info = binvalue.deserialize().unwrap();
        assert_eq!(
            service_info,
            Info {
    ...
    fn object_uid_from_binary_value() {
        ...
        let object_uid: object::Uid = binvalue.deserialize().unwrap();
        assert_eq!(
            object_uid,
            [
